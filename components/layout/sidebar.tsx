...
const MENU_GROUPS = [
  ...
  { label: 'Akademik & Belajar',  hrefs: ['/dashboard/akademik', '/dashboard/akademik/nilai', '/dashboard/tahfidz', '/dashboard/program-unggulan', '/dashboard/program-unggulan/kelola'] },
  { label: 'Tugas & Agenda Guru', hrefs: ['/dashboard/agenda', '/dashboard/nilai-harian', '/dashboard/monitoring-agenda', '/dashboard/monitoring-penugasan', '/dashboard/penugasan', '/dashboard/rapat'] },
