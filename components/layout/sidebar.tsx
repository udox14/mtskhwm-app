...
const MENU_GROUPS = [
  ...
  { label: 'Akademik',  hrefs: ['/dashboard/akademik', '/dashboard/akademik/nilai', '/dashboard/program-unggulan', '/dashboard/program-unggulan/kelola', '/dashboard/guru', '/dashboard/kehadiran', '/dashboard/agenda', '/dashboard/presensi', '/dashboard/monitoring-presensi', '/dashboard/monitoring-agenda'] },
