      ...
      <div className="rounded-xl border border-surface bg-surface shadow-sm">
        <div className="flex items-center gap-2 px-4 py-3 border-b border-surface-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 dark:text-slate-500">Laporan & kontrol akademik</p>
          </div>
        </div>
        <div className="p-2 grid grid-cols-1 sm:grid-cols-2 gap-0.5">
          <QuickLink href="/dashboard/monitoring-agenda"
            icon={<Activity className="h-4 w-4" />} iconBg="bg-cyan-50" iconColor="text-cyan-600"
            title="Monitoring Agenda" desc="Jurnal mengajar guru" />
          <QuickLink href="/dashboard/rekap-absensi"
            ...
            title="Rekap Absensi Siswa" desc="Kehadiran per kelas & bulan" />
          <QuickLink href="/dashboard/akademik/nilai"
            ...
            title="Rekap Nilai" desc="Capaian nilai akademik" />
          <QuickLink href="/dashboard/akademik"
            icon={<BarChart3 className="h-4 w-4" />} iconBg="bg-purple-50" iconColor="text-purple-600"
            title="Pusat Akademik" desc="Kelola data akademik" />
        </div>
      </div>
